...
export default function Signup() {
    ...
    const savedata= async ()=>{
       ...
       Alert.alert( "Warning!","The password must be at least 6 characters")
        ...
        //   fetch("https://test-urls.com/elitedesignhub/moyen-express/public/api/sing-up-api", {
        //      method: 'POST',
        //      headers: {
        ...
        <ScrollView>
            <View style={{ backgroundColor: "white", paddingLeft: 28.5, paddingRight: 27.5, paddingBottom: 100 }}>
                <View style={{ backgroundColor: "white" }}>
                    ...
                    <TextInput label="Enter You Name Name*" style={styles.te} value={username} selectionColor="#FF7E33" onChangeText={(text) => setUsername(text)} />
                    <Text style={{ marginBottom: 20.4 }}></Text>
                    <TextInput label="Email*" style={styles.te} selectionColor="#FF7E33" value={email} onChangeText={(text) => setEmail(text)} />
                    <Text style={{ marginBottom: 20.4 }}></Text>
                    <TextInput label="Number*" style={styles.te} keyboardType="number-pad" value={phone_number} selectionColor="#FF7E33" onChangeText={(text) => setPhone_number(text)} />
                    <Text style={{ marginBottom: 20.4 }}></Text>
                    <TextInput label="Password*" style={styles.te} secureTextEntry={true} value={password} selectionColor="#FF7E33" onChangeText={(text) => setPassword(text)} />
                    <Text style={{ marginBottom: 20.4 }}></Text>
                    <TextInput label="Confirm Password*" style={styles.te} secureTextEntry={true} value={confirm} selectionColor="#FF7E33" onChangeText={(text) => setConfirm(text)} />
                    <Text style={{ marginBottom: 20.4 }}></Text>
                </View>
                <View>
                ...
                <TouchableOpacity style={styles.ty} >
                    <Text style={{ fontSize: 14, textAlign: "center", color: "#512500" }} >Aleardy Have An Account ?</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.ty} >
                    <Text style={{ fontSize: 18, textAlign: "center", color: "#E9691D" }} >Login</Text>
                </TouchableOpacity>
            </View>
        </ScrollView>
    )
